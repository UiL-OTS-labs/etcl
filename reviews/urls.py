...
from .views import \
    DecisionListView, DecisionMyOpenView, DecisionOpenView, ReviewClosedView, \
    ReviewDetailView, \
    ReviewAssignView, ReviewCloseView, ReviewConfirmView, \
    DecisionUpdateView
...
urlpatterns = [
    ...
    url(r'^closed/$', ReviewClosedView.as_view(), name='closed'),
    ...
    url(r'^confirm/(?P<pk>\d+)/$', ReviewConfirmView.as_view(), name='confirm'),
